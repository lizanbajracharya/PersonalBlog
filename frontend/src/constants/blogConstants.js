...
export const MY_BLOG_LIST_REQUEST = "MY_BLOG_LIST_REQUEST";
export const MY_BLOG_LIST_SUCCESS = "MY_BLOG_LIST_SUCCESS";
export const MY_BLOG_LIST_FAIL = "MY_BLOG_LIST_FAIL";
export const MY_BLOG_LIST_RESET = "MY_BLOG_LIST_RESET";
